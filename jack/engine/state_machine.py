    ...
    def __init__(self):
        self.phases = [
            ...
            TradingPhase(
                ...
                eligible_strategies=["gap_fill", "gap_up_fade", "streak_fade", "theta_harvest", "iv_expansion_ride", "delta_scalp", "oi_wall_bounce"],
            ),
            TradingPhase(
                ...
                allowed_actions=["enter", "exit", "manage"],
                eligible_strategies=["first_hour_verdict", "iv_expansion_ride", "oi_confirmed_breakout", "delta_scalp", "oi_wall_bounce"],
            ),
            TradingPhase(
                name="dead_zone",
                start="11:15",
                ...
                eligible_strategies=["bb_squeeze", "vwap_reversion", "iv_expansion_ride", "oi_confirmed_breakout", "delta_scalp", "oi_wall_bounce"],
            ),
            TradingPhase(
                name="afternoon_push",
                start="13:15",
                ...
                allowed_actions=["enter", "exit", "manage"],
                eligible_strategies=["first_hour_verdict", "bb_squeeze", "vwap_reversion", "afternoon_breakout", "iv_expansion_ride", "oi_confirmed_breakout", "delta_scalp", "oi_wall_bounce"],
            ),
            TradingPhase(
                name="closing",
                start="15:00",
